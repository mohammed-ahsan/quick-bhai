...
const DeliveryScreen = () => {
  ...
  return (
    <View className="bg-green-400 h-[100%]">
      ...
      <MapView initaialRegion={{latitude:restaurant.lat,
...
longitude: restaurant.long,
      ...
      <SafeAreaView className="bg-white  flex-row items-center justify-center space-x-5 h-28">
        <Image
        source={{
          uri:"https://reactnative.dev/img/tiny_logo.png"
        }} className="h-12 w-12 bg-gray-300 p-4  rounded-full ml-5"/>
        <View className="flex-1 ">
          <Text className="text-lg">Ahsan</Text>
